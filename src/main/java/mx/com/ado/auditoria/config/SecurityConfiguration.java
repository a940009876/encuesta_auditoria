...
import mx.com.ado.auditoria.security.*;
import mx.com.ado.auditoria.web.filter.EncuestaPublicLoggingFilter;
import mx.com.ado.auditoria.web.filter.SpaWebFilter;
...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http, MvcRequestMatcher.Builder mvc) throws Exception {
        http
            ...
            .addFilterAfter(new EncuestaPublicLoggingFilter(), BasicAuthenticationFilter.class)
            ...
            .authorizeHttpRequests(authz ->
                ...
                authz
                    ...
                    .requestMatchers(mvc.pattern("/api/encuesta/**")).permitAll()
