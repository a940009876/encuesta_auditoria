...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './encuesta.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ENCUESTA_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ENCUESTA actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ENCUESTA actions', async () => {
      const arg = { id: 14693 };
    ...
    it('dispatches UPDATE_ENCUESTA actions', async () => {
      const arg = { id: 14693 };
    ...
    it('dispatches PARTIAL_UPDATE_ENCUESTA actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ENCUESTA actions', async () => {
      const arg = 42666;
