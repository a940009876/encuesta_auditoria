...
import reducer, {
  ...
  reset,
  updateEntity,
} from './aplicacion-encuesta.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APLICACIONENCUESTA_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_APLICACIONENCUESTA actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_APLICACIONENCUESTA actions', async () => {
      const arg = { id: 3478 };
    ...
    it('dispatches UPDATE_APLICACIONENCUESTA actions', async () => {
      const arg = { id: 3478 };
    ...
    it('dispatches PARTIAL_UPDATE_APLICACIONENCUESTA actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_APLICACIONENCUESTA actions', async () => {
      const arg = 42666;
