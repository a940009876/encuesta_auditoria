...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ENCUESTADO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ENCUESTADO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ENCUESTADO actions', async () => {
      const arg = { id: 7518 };
    ...
    it('dispatches UPDATE_ENCUESTADO actions', async () => {
      const arg = { id: 7518 };
    ...
    it('dispatches PARTIAL_UPDATE_ENCUESTADO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ENCUESTADO actions', async () => {
      const arg = 42666;
